...
export const projects: Project[] = [
  ...
  },
  {
    ...
    alt: "Kmstudy",
    description:
      "Responsive website for a mathematics and chemistry tutor, featuring online booking, student reviews, FAQ, and contact form submissions via Telegram and email.",
  ...
  },
  {
    id: "cityvet",
    name: "Cityvet",
    image: "/assets/img/projects/mockup-cityvet.webp",
    alt: "Cityvet",
    description: "No description yet.",
    tags: ["nextjs", "react", "typescript"],
    category: "web",
  ...
  },
  {
    ...
    tags: ["nextjs", "pet-project", "scss-modules", "typescript"],
    category: "web",
    year: "2026",
